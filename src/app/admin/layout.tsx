  ...
  return (
    <main className="min-h-screen bg-main-100 text-main-900">
      <div className="flex min-h-screen">
        <aside className="hidden w-72 border-r border-main-200 bg-main-100 lg:flex lg:flex-col">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-40 border-b border-main-200 bg-main-100/95 backdrop-blur-sm">
              ...
              <div className="flex items-center gap-3">
                <div className="relative flex-1 sm:w-80 sm:flex-none">
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-main-300 bg-main-50 px-10 py-2.5 text-sm font-medium text-main-900 outline-none placeholder:text-main-500 focus:border-primary-500 focus:bg-main-100"
                  />
                </div>
                <button
                  type="button"
                  className="flex size-11 items-center justify-center rounded-md border border-main-300 bg-main-100 text-main-700 hover:border-primary-400 hover:text-primary-700"
