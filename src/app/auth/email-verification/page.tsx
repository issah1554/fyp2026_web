          ...
          <form className="space-y-4" onSubmit={handleVerify}>
            ...
            <div>
              ...
              <input
                ...
                className="mt-2 w-full rounded-md border border-main-300 bg-main-100 px-4 py-3 text-center text-xl font-bold tracking-[0.35em] text-main-900 outline-none placeholder:text-main-500 focus:border-primary-500 focus:bg-main-0"
              />
            </div>
