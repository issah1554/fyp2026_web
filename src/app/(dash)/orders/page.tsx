      ...
      <section className="overflow-x-auto rounded-md border border-main-300 bg-main-200 p-5 shadow-sm">
        ...
        {loading ? <div className="py-12 text-center text-main-600">Loading orders...</div> : (
          <table className="w-full min-w-[52rem] text-left text-sm">
            <thead><tr className="border-b border-main-300 text-xs font-bold uppercase text-main-500"><th className="py-3 pr-4">Order</th><th className="py-3 pr-4">Commodity</th><th className="py-3 pr-4">Buyer</th><th className="py-3 pr-4">Quantity</th><th className="py-3 pr-4">Total</th><th className="py-3 pr-4">Status</th></tr></thead>
