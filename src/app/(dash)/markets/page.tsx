...
export default function MarketsPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 py-4">
      ...
      <section className="rounded-md border border-main-200 bg-main-100 p-5 shadow-sm">
        <div className="flex flex-col gap-3 border-b border-main-200 pb-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="grid gap-2 sm:grid-cols-[minmax(0,14rem)_10rem_12rem]">
            <input value={search} onChange={(event) => { setSearch(event.target.value); setPage(1); }} placeholder="Search markets" className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none placeholder:text-main-500 focus:border-primary-500 focus:bg-main-100" />
            <select value={statusFilter} onChange={(event) => { setStatusFilter(event.target.value); setPage(1); }} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100">
              <option value="">All status</option>
              <option value="active">Active</option>
              <option value="inactive">Inactive</option>
            </select>
            <select value={areaFilter} onChange={(event) => { setAreaFilter(event.target.value); setPage(1); }} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100">
      ...
      <section className="rounded-md border border-main-200 bg-main-100 p-5 shadow-sm">
        <div className="flex flex-col gap-3 border-b border-main-200 pb-4">
          ...
          <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-6">
            <select value={priceMarketFilter} onChange={(event) => { setPriceMarketFilter(event.target.value); setPricePage(1); }} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100"><option value="">All markets</option>{markets.map((market) => <option key={market.market_id} value={market.market_id}>{market.name}</option>)}</select>
            <select value={priceCommodityFilter} onChange={(event) => { setPriceCommodityFilter(event.target.value); setPricePage(1); }} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100"><option value="">All commodities</option>{commodities.map((commodity) => <option key={commodity.commodity_id} value={commodity.commodity_id}>{commodity.name}</option>)}</select>
            <select value={priceSourceFilter} onChange={(event) => { setPriceSourceFilter(event.target.value as SourceFilter); setPricePage(1); }} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100">{integrationSources.map((source) => <option key={source.value || "all"} value={source.value}>{source.label}</option>)}</select>
            <input type="date" value={priceDateFilter} onChange={(event) => { setPriceDateFilter(event.target.value); setPricePage(1); }} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" />
            <input type="date" value={dateFromFilter} onChange={(event) => { setDateFromFilter(event.target.value); setPricePage(1); }} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" />
            <input type="date" value={dateToFilter} onChange={(event) => { setDateToFilter(event.target.value); setPricePage(1); }} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" />
          </div>
        </div>
      ...
      <section className="rounded-md border border-main-200 bg-main-100 p-5 shadow-sm">
        <div className="flex flex-col gap-3 border-b border-main-200 pb-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="grid gap-2 sm:grid-cols-[minmax(0,16rem)_11rem]">
            ...
            }} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100"><option value="">Select commodity</option>{commodities.map((commodity) => <option key={commodity.commodity_id} value={commodity.commodity_id}>{commodity.name}</option>)}</select>
            <input type="date" value={comparisonDate} onChange={(event) => setComparisonDate(event.target.value)} className="rounded-md border border-main-300 bg-main-100 px-3 py-2 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" />
          </div>
        </div>
      ...
      <Modal open={Boolean(marketModal)} onClose={() => setMarketModal(null)} size="lg" className="rounded-md border border-main-300 bg-main-100 p-0 shadow-lg">
        <form onSubmit={(event) => void saveMarket(event)}>
          ...
          <div className="grid max-h-[calc(100vh-10rem)] gap-4 overflow-y-auto px-5 py-5 sm:grid-cols-2">
            ...
            <Field label="Name"><input required value={marketForm.name} onChange={(event) => setMarketForm((current) => ({ ...current, name: event.target.value }))} className="mt-2 w-full rounded-md border border-main-300 bg-main-100 px-4 py-2.5 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" /></Field>
            <Field label="Code"><input required value={marketForm.code} onChange={(event) => setMarketForm((current) => ({ ...current, code: event.target.value }))} className="mt-2 w-full rounded-md border border-main-300 bg-main-100 px-4 py-2.5 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" /></Field>
            <Field label="Admin area"><select required value={marketForm.admin_area_id} onChange={(event) => setMarketForm((current) => ({ ...current, admin_area_id: event.target.value }))} className="mt-2 w-full rounded-md border border-main-300 bg-main-100 px-4 py-2.5 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100"><option value="">Select admin area</option>{areas.map((area) => <option key={area.area_id} value={area.area_id}>{area.name}</option>)}</select></Field>
            <Field label="Status"><select value={marketForm.status} onChange={(event) => setMarketForm((current) => ({ ...current, status: event.target.value as MarketStatus }))} className="mt-2 w-full rounded-md border border-main-300 bg-main-100 px-4 py-2.5 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100"><option value="active">Active</option><option value="inactive">Inactive</option></select></Field>
            <Field label="Address"><input value={marketForm.address} onChange={(event) => setMarketForm((current) => ({ ...current, address: event.target.value }))} className="mt-2 w-full rounded-md border border-main-300 bg-main-100 px-4 py-2.5 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" /></Field>
            <Field label="Latitude"><input type="number" step="any" value={marketForm.latitude} onChange={(event) => setMarketForm((current) => ({ ...current, latitude: event.target.value }))} className="mt-2 w-full rounded-md border border-main-300 bg-main-100 px-4 py-2.5 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" /></Field>
            <Field label="Longitude"><input type="number" step="any" value={marketForm.longitude} onChange={(event) => setMarketForm((current) => ({ ...current, longitude: event.target.value }))} className="mt-2 w-full rounded-md border border-main-300 bg-main-100 px-4 py-2.5 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" /></Field>
            <div className="sm:col-span-2"><Field label="Description"><textarea rows={3} value={marketForm.description} onChange={(event) => setMarketForm((current) => ({ ...current, description: event.target.value }))} className="mt-2 w-full rounded-md border border-main-300 bg-main-100 px-4 py-2.5 text-sm text-main-900 outline-none focus:border-primary-500 focus:bg-main-100" /></Field></div>
          </div>
          <ModalActions saving={saving} saveText="Save market" onCancel={() => setMarketModal(null)} />
        </form>
      </Modal>

      <Modal open={Boolean(priceModal)} onClose={() => setPriceModal(null)} size="lg" className="rounded-md border border-main-300 bg-main-100 p-0 shadow-lg">
  ...
  return (
    <div className="rounded-md border border-main-200 bg-main-50 p-4">
      ...
      <div className="mt-3 space-y-2">
        {prices.length ? prices.map((price) => (
          <div key={`${title}-${price.price_id}`} className="rounded-md border border-main-200 bg-main-100 p-3">
        ...
        )) : <p className="rounded-md border border-main-200 bg-main-100 px-3 py-8 text-center text-sm text-main-500">No prices to show.</p>}
      </div>
    </div>
  );
}
