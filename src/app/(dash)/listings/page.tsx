...
export default function ListingsPage() {
  ...
  return (
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-6 py-4">
      ...
      <section className="overflow-x-auto rounded-md border border-main-300 bg-main-200 p-5 shadow-sm">
        ...
        {loading ? <div className="py-12 text-center text-main-600">Loading listings...</div> : (
          <table className="w-full min-w-[52rem] text-left text-sm">
            <thead><tr className="border-b border-main-300 text-xs font-bold uppercase text-main-500"><th className="py-3 pr-4">Commodity</th><th className="py-3 pr-4">Area</th><th className="py-3 pr-4">Quantity</th><th className="py-3 pr-4">Price</th><th className="py-3 pr-4">Seller</th><th className="py-3 pr-4">Status</th></tr></thead>
